...
define('Portafolio de David', 'genarodavid@gmail.com');
...
define('CONTACTFORM_TO_ADDRESS', 'genarodavid@gmail.com');
define('CONTACTFORM_TO_NAME', 'David Chirino');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'genarodavid@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', '2LDeW3oUvRjymV');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6Ld59lQgAAAAABEZA4ZyvT_Ax7IBuPpC2mwj3hWj');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6Ld59lQgAAAAANJCZHR4giCqut0D8DqwEceRWnFC');
